...
c.url.searchengines["DEFAULT"] = "https://www.google.com.hk/search?q={}"
...
c.bindings.commands['normal'] = {
	...
	'<meta-v>': 'scroll-page 0 -0.5',
	'<ctrl-shift-v>': 'scroll-page 0 1',
	'<meta-shift-v>': 'scroll-page 0 -1',
	...
	'<meta-l>': 'set-cmd-text -s :open -t',
	'<ctrl-x>f': 'set-cmd-text -s :open -t',
